...
class Window(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle('Riz MP3 Player')
    ...
    def _header(self):
        ...
        font = QFont('Copperplate', 40, QFont.Bold)
 
        text = scene.addText('Riz MP3 Player')
    ...
    def _footer(self):
        ...
        text = scene.addText('Rizqo Aidzin 220511180 TI22L')
        text.setDefaultTextColor(QColor(250,250,250))
        text.setFont(font)
